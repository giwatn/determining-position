// DETERMINING POSITION(MUSE EVENT)
...
var els = document.getElementById('body'); // Get body element
els.addEventListener('mousemove', showPosition, false); // Move updates position